...
```{r cols.min.print=32, rows.print=7, rownames.print = F}
demref2020 %>% 
  select(asylum_country, origin_country, locationn, urbanRural, statelessStatus, female_0_4:totalEndYear, typeOfDisaggregation, typeOfDisaggregationBroad) 
``` 
